function [alpha,ZFmult,data]=ZF(syst,WB,WC,Pflag,alpha_low)
...
if Pflag == 1
   data.etam =  dec2mat(LMISYS,xfeas,etaP); % Popov multiplier
   data.Vm   =  dec2mat(LMISYS,xfeas,VP);   % Circle multiplier
end
